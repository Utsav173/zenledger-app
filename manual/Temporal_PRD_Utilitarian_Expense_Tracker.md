...
| Project Name   | Temporal (Working Title)                                             |
| :------------- | :-------------------------------------------------------------------- |
...
**Temporal** is a minimalist, high-performance expense tracker designed for speed and clarity. It rejects modern "app bloat"—no gamification, no social features, no onboarding carousels.
