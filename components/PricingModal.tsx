  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
      ...
      <div className="relative z-10 w-full max-w-2xl animate-slide-up">
        <div className="relative overflow-hidden border-4 border-white bg-black p-12 shadow-[0_0_80px_rgba(255,255,255,0.15)]">
          ...
          <button
            onClick={onClose}
            className="absolute right-6 top-8 font-mono text-sm text-[#888888] transition-none hover:text-white"
          >
            [CLOSE]
          </button>
